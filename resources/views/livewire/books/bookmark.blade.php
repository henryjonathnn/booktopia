<div class="px-4 md:px-8 lg:px-16 py-8 pt-32">
    <div class="max-w-7xl mx-auto">
        {{-- Header --}}
        <div class="mb-8">
            <h1 class="text-3xl font-bold mb-2">Bookmark Saya</h1>
            <p class="text-gray-400">Koleksi buku yang Anda simpan untuk dibaca nanti</p>
        </div>
            ...
            <div class="flex flex-col md:flex-row gap-4">
                <div class="flex-1">
                    <input wire:model.live.debounce.500ms="search" type="text"
                        placeholder="Cari buku yang di-bookmark..."
        ...
        @else
            <div class="glass-effect rounded-xl p-8 border border-purple-500/10 text-center">
                <x-icon name="bookmark" class="w-16 h-16 text-gray-600 mx-auto mb-4" />
                <h3 class="text-xl font-semibold mb-2">Belum Ada Bookmark</h3>
                <p class="text-gray-400">Mulai tambahkan buku ke bookmark dengan menekan tombol bookmark pada buku yang ingin Anda baca nanti.</p>
