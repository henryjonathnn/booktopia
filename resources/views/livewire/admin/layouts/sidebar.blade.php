    ...
    >
        ...
        <div class="flex-1 py-4">
            ...
            <nav class="px-3 space-y-0.5">
                ...
                <a 
                    href="#" 
                    class="{{ request()->routeIs('admin.users*') ? 'bg-purple-500/20 text-purple-400 font-medium' : 'text-gray-400 hover:bg-[#2a2435] hover:text-gray-200' }} flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200"
                >
