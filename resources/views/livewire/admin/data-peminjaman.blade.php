                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        <div>
                            ...
                            <button wire:click="generatePDF" wire:loading.attr="disabled"
                                class="px-4 py-2.5 bg-purple-600 hover:bg-purple-700 text-white rounded-lg text-sm font-medium transition-colors flex items-center justify-center disabled:opacity-50">
