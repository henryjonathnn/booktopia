    ...
    <div class="min-h-screen flex flex-col">
        <div class="flex-grow pt-16">
                                ...
                                <td class="px-3 lg:px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-2 lg:gap-3">
                                        <div
                                            ...
                                            @if ($buku->cover_img)
                                                <img src="{{ Storage::url($buku->cover_img) }}"
                                                    alt="{{ $buku->judul }}" class="w-full h-full object-cover">
                                            @else
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="grid grid-cols-2 gap-2">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-sm">Rp
                                                        {{ number_format($selectedBuku->denda_harian, 0, ',', '.') }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        @if ($selectedBuku->deskripsi)
                                            <div>
                                                <h3 class="text-sm font-medium text-gray-500 uppercase mb-2">Deskripsi
                                                </h3>
                ...
                <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div class="bg-[#0f0a19] rounded-lg shadow-lg max-w-md w-full">
                        <div class="p-6">
                            ...
                            <p class="text-gray-300 mb-6">Apakah Anda yakin ingin menghapus buku ini? Tindakan ini
                                tidak
                                dapat dibatalkan.</p>

                            <div class="flex justify-end gap-3">
                                <button wire:click="$set('confirmingBukuDeletion', false)"
                                    class="px-4 py-2 bg-gray-800 text-gray-300 rounded-lg hover:bg-gray-700 transition-colors">
                                    Batal
                                </button>
            ...
            @if (count($selectedBooks) > 0)
                <div
                    class="fixed bottom-0 inset-x-0 pb-6 px-4 sm:px-6 lg:px-8 bg-[#0f0a19] border-t border-gray-800 z-30">
